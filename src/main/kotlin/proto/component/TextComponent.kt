...
// Source: component.TextComponent in TextMessage.proto
@file:Suppress(
  "DEPRECATION",
...
public class TextComponent(
  ...
  public fun copy(text: String = this.text, unknownFields: ByteString = this.unknownFields): TextComponent = TextComponent(text, unknownFields)
